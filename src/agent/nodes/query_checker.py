from src.agent.utils.prompts import QUERY_GRADE_PROMPT
...
class GradeDocuments(BaseModel):
    """Score for relevance check on given documents. documents could be a retrieved docs or queries."""

    score: str = Field(
        description="queries are relevant on given documents. 'yes', 'hold' or 'no'"
    )
